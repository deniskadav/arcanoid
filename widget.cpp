...
void Widget::on_about_button_clicked()
{
    ...
    ui->about->setText("\tДобро пожаловать!\n\n"
					   ...
					   "\nОна создана для моего сына (надоела реклама в уловно бесплатных играх) "
					   "\nСмысл игру простой - чтобы пройти игру, нужно отбивать платформой шар (шары) в сторону блоков. "
					   ...
					   "\nПрограмма является форком от проекта хорошего человека"
					   " https://github.com/Wasd96/");
